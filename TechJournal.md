...
[Vid 1](https://www.youtube.com/watch?v=I_qbPz4Psfg&t=4s)
[Vid 2](https://www.youtube.com/watch?v=JBKYwV4WsVA)
[Vid 3](https://www.youtube.com/watch?v=5-NlUPi28_M)
...
- Delivered a [full day (6-hr) AI workshop](https://www.linkedin.com/posts/chongtingho_ai-aitrainer-aiworkshop-ugcPost-7488986564400730112-U4Ej/?utm_source=share&utm_medium=member_desktop&rcm=ACoAAARotb8BSGh1yaKDeCZzswRdzN9ZmI3QxyE) themed "AI Financial Analysis Workshop" (AI 金融分析助手設計工作坊) at S.T.F.A. Lee Shau Kee College 順德聯誼總會李兆基中學 to 26 elite students from Secondary One to Four.
...
- Learnt more about the role of a forward-deployed engineer via the sharing from wonderful team.
...
- Renewed Microsoft Certified: Azure Solutions Architect Expert certification.
- Renewed Microsoft Certified: Azure Administrator Associate certification.
...
- Reinstalled Codex and cleared prior setting while configuring Codex++
...
- Delivered my 1st n8n lesson to Coco (AI111B) at Preface HQ.
- Successfully configured Google sign-in and connected my Google services (Email, Drive) via Google Cloud Console for my self-hosted n8n.
...
- Delivered the 3rd 1-on-1 private class (AI102A) to Savi at Preface HQ.
...
- Downloaded ima.copilot and connected it with custom Qwen model.
- Prepared for Microsoft AB-100 exam.
...
- Delivered the 2nd 1-on-1 private class (AI101B) to Savi.
...
- Used Comet browser to complete a task requiring Google sign-in, extracting information from different pages and compiling a document gathering all the information from different pages. 
...
- Had my first Mentimeter presentation to 160 student audience at Aberdeen Technical School on the topic "Preventing Financial Crime".
...
- Future testimonials would be gathered in this [testimonial page](https://testimonial.to/aitoolboxacademy/all) 
